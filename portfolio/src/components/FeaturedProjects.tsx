...
const projects = [
    {
        ...
        image: "https://ik.imagekit.io/c1bhqzfr6w/5fb6f5a9-618c-4858-bbdb-3646bcc09cdd.png",
        year: "2025",
    },
    {
        id: 2,
        title: "PASH",
        category: "Brand Identity",
        image: "https://ik.imagekit.io/c1bhqzfr6w/branding%20(1).png",
        year: "2024",
    },
    {
        id: 3,
        ...
        image: "https://ik.imagekit.io/c1bhqzfr6w/Untitled%20design%20(32).png",
        year: "2023",
    }
];
    ...
    return (
        <section ref={sectionRef} className="py-24 px-6 md:px-12 lg:px-24 bg-black text-white w-full relative z-30">
            <div ref={headerRef} className="flex flex-col md:flex-row justify-between items-end mb-16 md:mb-24">
                ...
                <a
                    href="https://www.behance.net/abhijeet2301"
                    target="_blank"
                    rel="noopener noreferrer"
                    className="interactable mt-8 md:mt-0 group flex items-center gap-3 text-lg border-b border-white pb-1 hover:text-gray-300 transition-colors cursor-pointer"
                >
                    View All Work
                ...
                {projects.map((project, index) => (
                    <div key={project.id} className={`flex flex-col ${index % 2 !== 0 ? 'md:flex-col-reverse lg:flex-row-reverse' : 'lg:flex-row'} gap-8 lg:gap-16 items-center group interactable cursor-pointer`}>
                        ...
                        <div className="w-full lg:w-2/5 flex flex-col justify-center">
                            ...
                            <a
                                href={
                                    project.id === 1 ? "https://www.behance.net/gallery/242457549/BRANDING-RAYAVRITI" :
                                        project.id === 2 ? "https://www.behance.net/gallery/238150265/PASH-CLOTHING-BRAND" :
                                            project.id === 3 ? "https://www.behance.net/gallery/212683775/RESTAURANT" :
                                                "#"
                                }
                                target={project.id === 1 || project.id === 2 || project.id === 3 ? "_blank" : "_self"}
                                rel="noopener noreferrer"
                                className="w-12 h-12 rounded-full border border-gray-600 flex items-center justify-center group-hover:bg-white group-hover:text-black transition-all cursor-pointer"
                            >
