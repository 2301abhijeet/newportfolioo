...
const qualifications = [
    {
        ...
        year: "2023 - 2027",
        description: "Focused on Artificial Intelligence, modern web development, and building intelligent digital experiences.",
        icon: <BookOpen className="w-6 h-6" />
    },
    {
        id: 2,
        title: "GEN-AI Advertising",
        institution: "Mindsclub Network",
        year: "2025",
        description: "Specialized in creating AI-generated videos and high-impact graphic advertisements.",
        icon: <Hexagon className="w-6 h-6" />
    },
    {
        id: 3,
        title: "Complete Branding Expert",
        institution: "Rajeev Mehta Academy ",
        year: "2023",
        description: "Focused on brand strategy, digital marketing, and building brands from scratch.",
